...
const options = {
  definition: {
    ...
    // Define API metadata
    info: {
      title: "Like and Comment Management System", // Name of your API
      version: "1.0.0", // API version
      description: "API documentation for Web API 101 - Like and Comment Management System", // Brief description
      contact: {
    ...
    servers: [
      ...
      {
        url: "https://sia-like-comment.onrender.com", // Production server
